...
class ChatBot
  ...
  # :nonew:
  def initialize(data, answer_limit)
    @markov_chain =
...
b = ChatBot.from({})
b.learn <<'TEXT'
лолита: Slackware 21 год! http://www.linux.org.ru/news/slackware/10693596 
 Видеолекции по теорфизике под свободной лицензией (update2) http://www.linux.org.ru/news/doc/10693278 
 Qt 5.3 портирован для Haiku OS http://www.linux.org.ru/news/opensource/10688071 
 Обновление Debian 6.0.10 http://www.linux.org.ru/news/debian/10688913 
 26 июля в Петербурге состоится Linux Fest http://www.linux.org.ru/news/conference/10688479 
 Вышел Stellarium 0.13.0 http://www.linux.org.ru/news/opensource/10686338 
TEXT
puts b.answer("x")
